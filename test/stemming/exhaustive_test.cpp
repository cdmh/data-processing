...
TEST_CASE("stemmer/exhaustive", "http://tartarus.org/martin/PorterStemmer/")
{
    ...
    CHECK(stem("agree") == original::stem("agree"));

    for (size_t i=0; i<sizeof(vocabulary)/sizeof(vocabulary[0]); ++i)
        CHECK(stem(vocabulary[i]) == original::stem(vocabulary[i]));
}
#endif
